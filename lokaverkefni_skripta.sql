...
VALUES
    ("Sounds of Silence",19640301,1),
    ("Parsley, Sage, Rosemary and Thyme",19651201,1),
    ("News of the World",19771028,3),
    ("Aerosmith",19730105,1),
    ("Faith",19871030,1),
    ("Bat Out of Hell",19771021,2),
    ("Toys in the Attic",19750408,1);
...
VALUES
    ("Spread Your Wings",274,"",3,5,4),
    ("We Are the Champions",179,"",3,5,4),
    ("We Will Rock You",121,"",3,5,4),
